...
export const PRONOUN_EMPHASIS_WORDS_ES = [
  "mismo",
  "misma",
  "mismos",
  "mismas",
...
export const POSSESSIVE_OWN_TRIGGERS_ES = [
  "propio",
  "propia",
  "propios",
  "propias",
...
export const PRONOUN_EMPHASIS_WORDS_EN = [
  "myself",
  "yourself",
  "himself",
  "herself",
...
export const POSSESSIVE_OWN_TRIGGERS_EN = ["own"];
...
export const HUMAN_ABLATIVE_PRONOUNS_GUP_EMPHATIC: Record<
  PersonNumber,
  string[]
> = {
  "1_Sing": ["rrakiyingalaŋuŋuru", "ŋarrakiyingalaŋuŋuru"],
  "2_Sing": ["nhokiyingalaŋuŋuru"],
  "3_Sing": ["nhanukiyingalaŋuŋuru"],
  "1+2_Dual": [
    "litjalaŋgiyingalaŋuŋuru",
    "ŋalitjalaŋgiyingalaŋuŋuru",
    "ŋilitjalaŋgiyingalaŋuŋuru",
  ],
  "1+3_Dual": [
    "linyalaŋgiyingalaŋuŋuru",
    "ŋalinyalaŋgiyingalaŋuŋuru",
    "ŋilinyalaŋgiyingalaŋuŋuru",
  ],
  "2_Dual": ["nhumalaŋgiyingalaŋuŋuru"],
  "3_Dual": ["maṉdaŋgiyingalaŋuŋuru"],
  "1+2_Plur": [
    "limurruŋgiyingalaŋuŋuru",
    "ŋalimurruŋgiyingalaŋuŋuru",
    "ŋilimurruŋgiyingalaŋuŋuru",
  ],
  "1+3_Plur": ["napurruŋgiyingalaŋuŋuru", "ŋanapurruŋgiyingalaŋuŋuru"],
  "2_Plur": ["nhumalaŋgiyingalaŋuŋuru"],
  "3_Plur": ["walalaŋgiyingalaŋuŋuru"],
};

function expandPerlativePronounForms(forms: string[]): string[] {
  const result: string[] = [];
  for (const form of forms) {
    const base = form.replace(/ŋuru$/, "");
    result.push(`${base}wurru`, `${base}kurru`);
  }
  return Array.from(new Set(result));
}

export const HUMAN_PERLATIVE_PRONOUNS_GUP: Record<PersonNumber, string[]> =
  Object.fromEntries(
    Object.entries(HUMAN_ABLATIVE_PRONOUNS_GUP).map(([key, forms]) => [
      key,
      expandPerlativePronounForms(forms),
    ])
  ) as Record<PersonNumber, string[]>;

export const HUMAN_PERLATIVE_PRONOUN_TRIGGERS_ES: Record<string, PersonNumber> =
  {
    "mientras mí": "1_Sing",
    "mientras mi": "1_Sing",
    "mientras ti": "2_Sing",
    "mientras él": "3_Sing",
    "mientras ella": "3_Sing",
    "mientras nosotros": "1+2_Plur",
    "mientras nosotras": "1+2_Plur",
    "mientras vosotros": "2_Plur",
    "mientras vosotras": "2_Plur",
    "mientras ustedes": "2_Plur",
    "mientras ellos": "3_Plur",
    "mientras ellas": "3_Plur",
    "durante mí": "1_Sing",
    "durante mi": "1_Sing",
    "durante ti": "2_Sing",
    "durante él": "3_Sing",
    "durante ella": "3_Sing",
    "durante nosotros": "1+2_Plur",
    "durante nosotras": "1+2_Plur",
    "durante vosotros": "2_Plur",
    "durante vosotras": "2_Plur",
    "durante ustedes": "2_Plur",
    "durante ellos": "3_Plur",
    "durante ellas": "3_Plur",
    "a través de mí": "1_Sing",
    "a través de mi": "1_Sing",
    "a traves de mi": "1_Sing",
    "a traves de mí": "1_Sing",
    "a través de ti": "2_Sing",
    "a traves de ti": "2_Sing",
    "a través de él": "3_Sing",
    "a través de ella": "3_Sing",
    "a traves de el": "3_Sing",
    "a traves de ella": "3_Sing",
    "a través de nosotros": "1+2_Plur",
    "a través de nosotras": "1+2_Plur",
    "a traves de nosotros": "1+2_Plur",
    "a traves de nosotras": "1+2_Plur",
    "a través de vosotros": "2_Plur",
    "a través de vosotras": "2_Plur",
    "a traves de vosotros": "2_Plur",
    "a traves de vosotras": "2_Plur",
    "a través de ustedes": "2_Plur",
    "a traves de ustedes": "2_Plur",
    "a través de ellos": "3_Plur",
    "a través de ellas": "3_Plur",
    "a traves de ellos": "3_Plur",
    "a traves de ellas": "3_Plur",
  };

export const HUMAN_PERLATIVE_PRONOUN_TRIGGERS_EN: Record<string, PersonNumber> =
  {
    "while me": "1_Sing",
    "while you": "2_Sing",
    "while him": "3_Sing",
...
export const CAUSE_PRONOUN_TRIGGERS_ES: Record<string, PersonNumber> = {
  "por mí": "1_Sing",
  "por mi": "1_Sing",
  "a causa de mí": "1_Sing",
  "a causa de mi": "1_Sing",
  "por causa de mí": "1_Sing",
  "por causa de mi": "1_Sing",
  "por culpa de mí": "1_Sing",
  "por culpa de mi": "1_Sing",
  "debido a mí": "1_Sing",
  "debido a mi": "1_Sing",
  "por ti": "2_Sing",
  "a causa de ti": "2_Sing",
  "por causa de ti": "2_Sing",
  "por culpa de ti": "2_Sing",
  "debido a ti": "2_Sing",
  "por él": "3_Sing",
  "por el": "3_Sing",
  "a causa de él": "3_Sing",
  "a causa de el": "3_Sing",
  "por causa de él": "3_Sing",
  "por causa de el": "3_Sing",
  "por culpa de él": "3_Sing",
  "por culpa de el": "3_Sing",
  "debido a él": "3_Sing",
  "debido a el": "3_Sing",
  "por ella": "3_Sing",
  "a causa de ella": "3_Sing",
  "por causa de ella": "3_Sing",
  "por culpa de ella": "3_Sing",
  "debido a ella": "3_Sing",
  "por nosotros": "1+2_Plur",
  "por nosotras": "1+2_Plur",
  "a causa de nosotros": "1+2_Plur",
  "a causa de nosotras": "1+2_Plur",
  "por causa de nosotros": "1+2_Plur",
  "por causa de nosotras": "1+2_Plur",
  "por culpa de nosotros": "1+2_Plur",
  "por culpa de nosotras": "1+2_Plur",
  "debido a nosotros": "1+2_Plur",
  "debido a nosotras": "1+2_Plur",
  "por vosotros": "2_Plur",
  "por vosotras": "2_Plur",
  "a causa de vosotros": "2_Plur",
  "a causa de vosotras": "2_Plur",
  "por causa de vosotros": "2_Plur",
  "por causa de vosotras": "2_Plur",
  "por culpa de vosotros": "2_Plur",
  "por culpa de vosotras": "2_Plur",
  "debido a vosotros": "2_Plur",
  "debido a vosotras": "2_Plur",
  "por ustedes": "2_Plur",
  "a causa de ustedes": "2_Plur",
  "por causa de ustedes": "2_Plur",
  "por culpa de ustedes": "2_Plur",
  "debido a ustedes": "2_Plur",
  "por ellos": "3_Plur",
  "por ellas": "3_Plur",
  "a causa de ellos": "3_Plur",
  "a causa de ellas": "3_Plur",
  "por causa de ellos": "3_Plur",
  "por causa de ellas": "3_Plur",
  "por culpa de ellos": "3_Plur",
  "por culpa de ellas": "3_Plur",
  "debido a ellos": "3_Plur",
  "debido a ellas": "3_Plur",
};

export const CAUSE_PRONOUN_TRIGGERS_EN: Record<string, PersonNumber> = {
  "because of me": "1_Sing",
  "due to me": "1_Sing",
  "owing to me": "1_Sing",
  "for the reason of me": "1_Sing",
  "because of you": "2_Sing",
  "due to you": "2_Sing",
  "owing to you": "2_Sing",
  "for the reason of you": "2_Sing",
  "because of him": "3_Sing",
  "due to him": "3_Sing",
  "owing to him": "3_Sing",
  "for the reason of him": "3_Sing",
  "because of her": "3_Sing",
  "due to her": "3_Sing",
  "owing to her": "3_Sing",
  "for the reason of her": "3_Sing",
  "because of us": "1+2_Plur",
  "due to us": "1+2_Plur",
  "owing to us": "1+2_Plur",
  "for the reason of us": "1+2_Plur",
  "because of them": "3_Plur",
  "due to them": "3_Plur",
  "owing to them": "3_Plur",
  "for the reason of them": "3_Plur",
};
...
export const HUMAN_ALLATIVE_PRONOUNS_GUP_EMPHATIC: Record<
  PersonNumber,
  string[]
> = {
  "1_Sing": ["rrakiyingala", "ŋarrakiyingala"],
  "2_Sing": ["nhokiyingala"],
...
export const EMPHATIC_SUBJECT_TRIGGERS_ES: Record<string, PersonNumber | null> = {
  "yo mismo": "1_Sing",
  "yo misma": "1_Sing",
  "tu mismo": "2_Sing",
  "tú mismo": "2_Sing",
  ...
  "él mismo": "3_Sing",
  "ella misma": "3_Sing",
  "nosotros mismos": "1+2_Plur",
  "nosotras mismas": "1+2_Plur",
  "ustedes mismos": "2_Plur",
  "ustedes mismas": "2_Plur",
  "vosotros mismos": "2_Plur",
  "vosotras mismas": "2_Plur",
  "ellos mismos": "3_Plur",
  "ellas mismas": "3_Plur",
  "en persona": null,
};
...
export const EMPHATIC_SUBJECT_TRIGGERS_EN: Record<string, PersonNumber | null> = {
  "i myself": "1_Sing",
  myself: "1_Sing",
  "you yourself": "2_Sing",
  yourself: "2_Sing",
  "you yourselves": "2_Plur",
  yourselves: "2_Plur",
  "he himself": "3_Sing",
  himself: "3_Sing",
  "she herself": "3_Sing",
  ...
  "it itself": "3_Sing",
  itself: "3_Sing",
  "we ourselves": "1+2_Plur",
  ourselves: "1+2_Plur",
  "they themselves": "3_Plur",
  themselves: "3_Plur",
  "in person": null,
};
...
export const ABOUT_TO_TRIGGERS_ES = [
  ...ESTAR_PRESENT,
  ...ESTAR_PAST,
  ...ESTAR_FUTURE,
].flatMap((form) => [`${form} a punto de`, `${form} por`]);

export const HABITUAL_TRIGGERS_ES = [
  "todos los días",
  "todos los dias",
  "cada día",
  "cada dia",
...
export const HABITUAL_TRIGGERS_EN = [
  "every day",
  "everyday",
  "always",
  "often",
...
export const MIGHT_TRIGGERS_ES = [
  "quizá",
  "quizas",
  "quizás",
  "tal vez",
...
export const MIGHT_PAST_TRIGGERS_ES = [
  "podría haber",
  "podria haber",
  "podrías haber",
  "podrias haber",
...
export const SHOULD_TRIGGERS_ES = [
  "debería",
  "deberia",
  "deberías",
  "deberias",
...
export const SHOULD_PAST_TRIGGERS_ES = [
  "debería haber",
  "deberia haber",
  "deberías haber",
  "deberias haber",
...
export const MIGHT_TRIGGERS_EN = [
  "might",
  "maybe",
  "perhaps",
  "may",
...
export const MIGHT_PAST_TRIGGERS_EN = [
  "might have",
  "could have",
  "may have",
];

export const SHOULD_TRIGGERS_EN = [
  "should",
  "would",
  "must",
  "shouldnt",
...
export const SHOULD_PAST_TRIGGERS_EN = [
  "should have",
  "would have",
  "must have",
  "should not have",
...
export const HABITUAL_PAST_AUX_TRIGGERS_ES = [
  "solía",
  "solia",
  "solías",
  "solias",
...
export const HABITUAL_PAST_AUX_TRIGGERS_EN = ["used to"];

export const THAT_TIME_TRIGGERS_ES = [
  "esa vez",
  "aquella vez",
  "esa ocasión",
  "esa ocasion",
...
export const THAT_TIME_TRIGGERS_EN = [
  "that time",
  "that occasion",
];
...
export const OBJECT_PRONOUNS_EMPHATIC_GUP: Record<
  ObjectPronounType,
  ObjectPronounOption
> = {
  "1_Sing": {
    gup: "ŋarrapinya",
    alternatives: ["rrapinya", "ŋarranhawuynha", "rranhawuynha"],
    explanation: "ŋarranhapinya = me",
  },
  "2_Sing": {
    gup: "nhunapinya",
    alternatives: ["nhunapinyawuy"],
    explanation: "nhunapinya = you",
  },
  "3_Sing": {
    gup: "ŋanyapinya",
    alternatives: ["ŋanyapinyawuy"],
    explanation: "ŋanyapinya = him/her/it",
  },
  "1_Dual_Incl": {
    gup: "ŋalitjalanhawuynha",
    alternatives: ["ŋilitjalanhawuynha", "litjalanhawuynha"],
    explanation: "ŋalitjalanhawuynha = us (dual inclusive)",
  },
  "1_Dual_Excl": {
    gup: "ŋalinyalanhawuynha",
    alternatives: ["linyalanhawuynha", "ŋilinyalanhawuynha"],
    explanation: "ŋalinyalanhawuynha = us (dual exclusive)",
  },
  "2_Dual": {
    gup: "nhumalanhawuynha",
    alternatives: [],
    explanation: "nhumalanhawuynha = you two",
  },
  "3_Dual": {
    gup: "maṉḏanhawuynha",
    alternatives: [],
    explanation: "maṉḏanhawuynha = them two",
  },
  "1+2_Plur_Incl": {
    gup: "ŋalimurrunhawuynha",
    alternatives: ["ŋilimurrunhawuynha", "limurrunhawuynha"],
    explanation: "ŋalimurrunhawuynha = us (plural inclusive)",
  },
  "1+2_Plur_Excl": {
    gup: "ŋanapurrunhawuynha",
    alternatives: ["napurrunhawuynha"],
    explanation: "ŋanapurrunhawuynha = us (plural exclusive)",
  },
  "2_Plur": {
    gup: "nhumalanhawuynha",
    alternatives: [],
    explanation: "nhumalanhawuynha = you all",
  },
  "3_Plur": {
    gup: "walalanhawuynha",
    alternatives: [],
    explanation: "walalanhawuynha = them",
  },
};

export const OBJECT_EMPHATIC_TRIGGERS_ES: Record<
  string,
  ObjectPronounType[] | null
> = {
  "a mi mismo": ["1_Sing"],
  "a mí mismo": ["1_Sing"],
  "a mi misma": ["1_Sing"],
  ...
  "a él mismo": ["3_Sing"],
  "a ella misma": ["3_Sing"],
  "a usted mismo": ["3_Sing"],
  "a usted misma": ["3_Sing"],
  "a nosotros mismos": [
    "1_Dual_Incl",
    "1_Dual_Excl",
    "1+2_Plur_Incl",
  ...
  "a ustedes mismos": ["2_Dual", "2_Plur"],
  "a ustedes mismas": ["2_Dual", "2_Plur"],
  "a vosotros mismos": ["2_Dual", "2_Plur"],
  "a vosotras mismas": ["2_Dual", "2_Plur"],
  "a ellos mismos": ["3_Dual", "3_Plur"],
  "a ellas mismas": ["3_Dual", "3_Plur"],
  "por si mismo": null,
  "por sí mismo": null,
  "por si misma": null,
  "por sí misma": null,
...
export const OBJECT_EMPHATIC_TRIGGERS_EN: Record<
  string,
  ObjectPronounType[] | null
> = {
  "by myself": ["1_Sing"],
...
export interface LanguageConfig {
  ...
  emphaticSubjectTriggers: Record<string, PersonNumber | null>;
  dualSubjectPatterns: Record<string, PersonNumber>;
  skipWords: string[];
  negation: string[];
  objectPronounTriggers: Record<string, ObjectPronounType[]>;
  objectEmphaticTriggers?: Record<string, ObjectPronounType[] | null>;
  pronounEmphasisWords?: string[];
  possessiveOwnTriggers?: string[];
  ...
  pointingHereTriggers: string[];
  pointingThereTriggers: string[];
  causeTriggers: string[];
  causativeAgentTriggers: string[];
  locativeVerbTriggers: string[];
  allativeVerbTriggers: string[];
  ablativeVerbTriggers: string[];
  perlativeVerbTriggers: string[];
  perlativeTimeTriggers: string[];
  ...
  humanPerlativePronounTriggers: Record<string, PersonNumber>;
  humanPerlativePronounsGup: Record<PersonNumber, string[]>;
  sourceOriginPronounTriggers: Record<string, PersonNumber>;
  sourceOriginPronounsGup: Record<PersonNumber, string[]>;
  causePronounTriggers: Record<string, PersonNumber>;
  causePronounsGup: Record<PersonNumber, string[]>;
  ...
  aboutToTriggers: string[];
  habitualTriggers: string[];
  habitualPastAuxTriggers: string[];
  mightTriggers: string[];
  mightPastTriggers: string[];
  shouldTriggers: string[];
  shouldPastTriggers: string[];
  thatTimeTriggers: string[];
  ngarraAboutToTriggers: string[];
  ngarraGoingToTriggers: string[];
  mindIfTriggers: string[];
}
...
export const PERLATIVE_TRIGGERS_ES = [
  "a través de",
  "a través del",
  "a través de la",
  "a través de los",
...
export const PERLATIVE_TRIGGERS_EN = [
  "through",
  "through the",
  "through a",
  "through an",
...
export const PERLATIVE_TIME_TRIGGERS_ES = [
  "mientras",
  "durante",
  "durante el",
  "durante la",
...
export const PERLATIVE_TIME_TRIGGERS_EN = [
  "while",
  "during",
  "during the",
  "during a",
...
export const CAUSE_TRIGGERS_ES = [
  "por",
  "a causa de",
  "a causa del",
  "por causa de",
...
export const CAUSE_TRIGGERS_EN = [
  "because of",
  "due to",
  "owing to",
  "for the reason of",
...
export const CAUSATIVE_AGENT_TRIGGERS_ES = ["por parte de", "a manos de", "por"];
export const CAUSATIVE_AGENT_TRIGGERS_EN = ["by"];
...
export const POINTING_HERE_TRIGGERS_ES = ["aquí", "aqui", "acá", "aca"];
export const POINTING_THERE_TRIGGERS_ES = [
  "allí",
  "alli",
  "ahí",
  "ahi",
...
export const POINTING_HERE_TRIGGERS_EN = ["here", "over here"];
export const POINTING_THERE_TRIGGERS_EN = ["there", "over there"];
...
export function applyHumanAssociativeSuffix(
  ...
  return validarFonologia(word + suffix);
}

export type PerlativeSuffixType = "gurru" | "kurru" | "wurru";

export function determinePerlativeSuffix(
  gupWord: string
): PerlativeSuffixType[] {
  const word = gupWord.trim();
  const ending = getWordEnding(word);
  ...
  if (hasGlottal) {
    ...
    if (
      ALL_VOWELS.includes(charBeforeGlottal) ||
      LIQUIDS.includes(charBeforeGlottal) ||
      SEMIVOWELS.includes(charBeforeGlottal)
    ) {
      return ["kurru", "wurru"];
    }
    if (NON_GLOTTAL_STOPS.includes(charBeforeGlottal)) {
      return ["kurru"];
    }
    return ["kurru"];
  }
  ...
  if (
    ALL_VOWELS.includes(effectiveEnding) ||
    LIQUIDS.includes(effectiveEnding) ||
    SEMIVOWELS.includes(effectiveEnding)
  ) {
    return ["kurru", "wurru"];
...
export function applyPerlativeSuffix(
  gupWord: string,
  suffix: PerlativeSuffixType
): string {
  const word = gupWord.replace(/['ʼ`']/g, "'").trim();
  return validarFonologia(word + suffix);
}

export type HumanCausativeSuffixType = "wuŋu" | "kuŋu" | "guŋu";

export function determineHumanCausativeSuffix(
  gupWord: string
): HumanCausativeSuffixType[] {
  const assocSuffixes = determineHumanAssociativeSuffix(gupWord);
  return assocSuffixes.map((s) =>
    s === "gala" ? "guŋu" : s === "kala" ? "kuŋu" : "wuŋu"
  );
}

export function applyHumanCausativeSuffix(
  gupWord: string,
  suffix: HumanCausativeSuffixType
): string {
  const word = gupWord.replace(/['ʼ`']/g, "'").trim();
  return validarFonologia(word + suffix);
}
...
export const PATTERNS_ES: VerbPattern[] = [
  ...
  {
    name: "estar_present_a_punto_de_infinitive",
    match: [
      { type: "wordList", words: ESTAR_PRESENT },
      { type: "literal", word: "a" },
      { type: "literal", word: "punto" },
      { type: "literal", word: "de" },
      { type: "verbForm", forms: ["infinitive"] },
    ],
    result: { tense: "future", isContinuous: false },
  },
  {
    name: "estar_present_por_infinitive",
    match: [
      { type: "wordList", words: ESTAR_PRESENT },
      { type: "literal", word: "por" },
      { type: "verbForm", forms: ["infinitive"] },
    ],
    result: { tense: "future", isContinuous: false },
  },
  {
    name: "estar_past_a_punto_de_infinitive",
    match: [
      { type: "wordList", words: ESTAR_PAST },
      { type: "literal", word: "a" },
      { type: "literal", word: "punto" },
  ...
  {
    name: "estar_past_por_infinitive",
    match: [
      { type: "wordList", words: ESTAR_PAST },
      { type: "literal", word: "por" },
      { type: "verbForm", forms: ["infinitive"] },
  ...
  {
    name: "estar_future_a_punto_de_infinitive",
    match: [
      { type: "wordList", words: ESTAR_FUTURE },
      { type: "literal", word: "a" },
      { type: "literal", word: "punto" },
  ...
  {
    name: "estar_future_por_infinitive",
    match: [
      { type: "wordList", words: ESTAR_FUTURE },
      { type: "literal", word: "por" },
      { type: "verbForm", forms: ["infinitive"] },
...
export const LANG_CONFIG: Record<LanguageMode, LanguageConfig> = {
  es: {
    ...
    emphaticSubjectTriggers: EMPHATIC_SUBJECT_TRIGGERS_ES,
    ...
    objectEmphaticTriggers: OBJECT_EMPHATIC_TRIGGERS_ES,
    pronounEmphasisWords: PRONOUN_EMPHASIS_WORDS_ES,
    possessiveOwnTriggers: POSSESSIVE_OWN_TRIGGERS_ES,
    ...
    pointingHereTriggers: POINTING_HERE_TRIGGERS_ES,
    pointingThereTriggers: POINTING_THERE_TRIGGERS_ES,
    causeTriggers: CAUSE_TRIGGERS_ES,
    causativeAgentTriggers: CAUSATIVE_AGENT_TRIGGERS_ES,
    ...
    perlativeVerbTriggers: PERLATIVE_TRIGGERS_ES,
    perlativeTimeTriggers: PERLATIVE_TIME_TRIGGERS_ES,
    ...
    humanPerlativePronounTriggers: HUMAN_PERLATIVE_PRONOUN_TRIGGERS_ES,
    humanPerlativePronounsGup: HUMAN_PERLATIVE_PRONOUNS_GUP,
    sourceOriginPronounTriggers: SOURCE_ORIGIN_PRONOUN_TRIGGERS_ES,
    sourceOriginPronounsGup: SOURCE_ORIGIN_PRONOUNS_GUP,
    causePronounTriggers: CAUSE_PRONOUN_TRIGGERS_ES,
    causePronounsGup: HUMAN_ALLATIVE_PRONOUNS_GUP,
    ...
    causativeAgentLabel: "agente causante",
    withThing: "con cosa",
    ...
    perlativeLabel: "a través de / a lo largo de",
    ...
    letUsVerbWord: "vamos",
    letUsPreposition: "a",
    aboutToTriggers: ABOUT_TO_TRIGGERS_ES,
    habitualTriggers: HABITUAL_TRIGGERS_ES,
    habitualPastAuxTriggers: HABITUAL_PAST_AUX_TRIGGERS_ES,
    mightTriggers: MIGHT_TRIGGERS_ES,
    mightPastTriggers: MIGHT_PAST_TRIGGERS_ES,
    shouldTriggers: SHOULD_TRIGGERS_ES,
    shouldPastTriggers: SHOULD_PAST_TRIGGERS_ES,
    thatTimeTriggers: THAT_TIME_TRIGGERS_ES,
  ...
  en: {
    ...
    emphaticSubjectTriggers: EMPHATIC_SUBJECT_TRIGGERS_EN,
    ...
    objectEmphaticTriggers: OBJECT_EMPHATIC_TRIGGERS_EN,
    pronounEmphasisWords: PRONOUN_EMPHASIS_WORDS_EN,
    possessiveOwnTriggers: POSSESSIVE_OWN_TRIGGERS_EN,
    subjectPronounsGup: SUBJECT_PRONOUNS_GUP,
    ...
    pointingHereTriggers: POINTING_HERE_TRIGGERS_EN,
    pointingThereTriggers: POINTING_THERE_TRIGGERS_EN,
    causeTriggers: CAUSE_TRIGGERS_EN,
    causativeAgentTriggers: CAUSATIVE_AGENT_TRIGGERS_EN,
    ...
    perlativeVerbTriggers: PERLATIVE_TRIGGERS_EN,
    perlativeTimeTriggers: PERLATIVE_TIME_TRIGGERS_EN,
    ...
    humanAblativePronounsGup: HUMAN_ABLATIVE_PRONOUNS_GUP,
    humanPerlativePronounTriggers: HUMAN_PERLATIVE_PRONOUN_TRIGGERS_EN,
    humanPerlativePronounsGup: HUMAN_PERLATIVE_PRONOUNS_GUP,
    sourceOriginPronounTriggers: SOURCE_ORIGIN_PRONOUN_TRIGGERS_EN,
    sourceOriginPronounsGup: SOURCE_ORIGIN_PRONOUNS_GUP,
    causePronounTriggers: CAUSE_PRONOUN_TRIGGERS_EN,
    causePronounsGup: HUMAN_ALLATIVE_PRONOUNS_GUP,
    ...
    causativeAgentLabel: "causative agent",
    ...
    letUsVerbWord: "",
    letUsPreposition: "",
    aboutToTriggers: ["i'm about to", "i am about to", "im about to"],
    habitualTriggers: HABITUAL_TRIGGERS_EN,
    habitualPastAuxTriggers: HABITUAL_PAST_AUX_TRIGGERS_EN,
    mightTriggers: MIGHT_TRIGGERS_EN,
    mightPastTriggers: MIGHT_PAST_TRIGGERS_EN,
    shouldTriggers: SHOULD_TRIGGERS_EN,
    shouldPastTriggers: SHOULD_PAST_TRIGGERS_EN,
    thatTimeTriggers: THAT_TIME_TRIGGERS_EN,
    ngarraAboutToTriggers: ["i'm about to", "i am about to", "im about to"],
    ngarraGoingToTriggers: ["i'm going to", "i am going to", "im going to"],
    mindIfTriggers: ["do you mind if", "would you mind if"],
  },
};
