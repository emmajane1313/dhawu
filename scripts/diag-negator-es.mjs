...
const negPath = path.join(root, "src/app/ridjin/traductor/logic/negation.ts");
const { isNegatorToken } = loadModule(negPath);
console.log(isNegatorToken({ source: "estás" }, "es"));
