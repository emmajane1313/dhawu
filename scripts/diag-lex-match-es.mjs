...
const lexPath = path.join(root, "src/app/ridjin/traductor/logic/lexiconMatch.ts");
const { matchAdjectiveAt, matchNounAt } = loadModule(lexPath);

const tokens = [{ source: "pequeño", normalized: "pequeño", id: "es-0", pos: "unknown" }];
console.log("adj:", matchAdjectiveAt(tokens, 0, "es"));
console.log("noun:", matchNounAt(tokens, 0, "es"));
