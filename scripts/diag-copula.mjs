...
const copulaPath = path.join(root, "src/app/ridjin/traductor/logic/copula.ts");
const verbAuxPath = path.join(root, "src/app/ridjin/traductor/logic/verbAux.ts");
const { matchCopulaAt } = loadModule(copulaPath);
const { getAuxGerundInfo } = loadModule(verbAuxPath);
...
console.log("aux was:", getAuxGerundInfo("was", "en"));
console.log("copula was:", matchCopulaAt(tokens, 1, "en"));
